 ...
 * @author Madytyoo
 */
public class Calendar extends AbstractItem {
    ...
    public Calendar(String name,String label, Integer width, Integer labelWidth, String labelAlign,String position) {
        this.name = name;
        this.label = label;
        this.width = width;
    ...
    public String renderWeb(DefaultFormAdapter adapter, Locale locale) {
        ...
        buffer.append( formatAttribute("dateFormat", "%Y-%m-%d" ) );
